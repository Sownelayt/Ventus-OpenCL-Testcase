#define bulk_pattern_word g2s_mixed_bulk_pattern_word
#define stress_pattern_word g2s_mixed_stress_pattern_word
#define tensor_s2g_pattern_word g2s_mixed_tensor_s2g_pattern_word
#define build_desc g2s_mixed_build_desc
#define fill_src g2s_mixed_fill_src
#define fill_bulk_pattern g2s_mixed_fill_bulk_pattern
#define compute_expected g2s_mixed_compute_expected
#define fill_tensor_s2g_expected g2s_mixed_fill_tensor_s2g_expected
#define first_mismatch g2s_mixed_first_mismatch
#define check_bytes g2s_mixed_check_bytes
#define check_marker_xor g2s_mixed_check_marker_xor
#define check_complex_marker g2s_mixed_check_complex_marker
#define run_bulk_case g2s_mixed_run_bulk_case
#define run_tensor_case g2s_mixed_run_tensor_case
#define run_bulk_multi_issue_case g2s_mixed_run_bulk_multi_issue_case
#define run_tensor_bulk_complex_case g2s_mixed_run_tensor_bulk_complex_case
/*
...
int
g2s_mixed_async_fence_case_main(void)
{
  cl_int err = CL_SUCCESS;
