#define desc_control g2s_tma_descriptor_desc_control
#define fill_src g2s_tma_descriptor_fill_src
#define build_desc g2s_tma_descriptor_build_desc
#define compute_expected g2s_tma_descriptor_compute_expected
#define first_mismatch g2s_tma_descriptor_first_mismatch
#define check_bytes g2s_tma_descriptor_check_bytes
/*
...
int
g2s_tma_descriptor_case_main(void)
{
