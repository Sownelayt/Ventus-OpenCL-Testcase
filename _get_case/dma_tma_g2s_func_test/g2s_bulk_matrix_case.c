#define g_cases g2s_bulk_matrix_cases
#define fill_src g2s_bulk_matrix_fill_src
#define run_one g2s_bulk_matrix_run_one
/*
...
int
g2s_bulk_matrix_case_main(int argc, char **argv)
{
  cl_int err;
